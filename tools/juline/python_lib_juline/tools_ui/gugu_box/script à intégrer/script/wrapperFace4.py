...
if "L_" in mshToWrap:
    mshToWrap = mshToWrap.replace("L_", "l_")
if "R_" in mshToWrap:
    mshToWrap = mshToWrap.replace("R_", "r_")
...
mc.connectAttr(delCompWrprBase + ".outputGeometry", wrprBase + ".inMesh", force=True)
