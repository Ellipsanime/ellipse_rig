...
DEBUG V4.7:
ligne 89 : modif nameSpace replace RigOk par rig for pipe V2
"""
...
#skiner wrprBase
mc.skinCluster(nameSpace.replace("ModelingOk","rig") + ":head_skn", wrprBase, toSelectedBones=True, name=wrpr + "Deformed_skinCluster1")
