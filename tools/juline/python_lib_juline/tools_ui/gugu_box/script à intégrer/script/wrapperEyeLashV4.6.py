"""
SCRIPT WRAPPER EYELASHES / EYEBROWS V4.6
...
DEBUG V4.6:
ligne 89 : ajout du flag toSelectedBones lors du skin du wrapperBase
"""
...
#skiner wrprBase
mc.skinCluster(nameSpace.replace("ModelingOk","RigOk") + ":head_skn", wrprBase, toSelectedBones=True, name=wrpr + "Deformed_skinCluster1")
